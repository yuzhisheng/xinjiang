...
export const MAP_STOPS = [
  ...
  {
    uid: 'kanas', day: 'D3-4', name: '喀纳斯', sub: '三湾 · 晨雾 · 观鱼台 · 湖边栈道',
    lat: 48.691747, lng: 87.025975, type: 'star',
    desc: '9/27 宿景区内云中歌（新村），9/28 出山宿贾登峪疆峪。D3 傍晚三湾 2 版；D4 以「晨雾 + 观鱼台登高」为主计划，另有「三湾 + 湖区」「湖区深耕」两个平地版可切换（见当日卡片）；观鱼台开放状态行前电话复核（"关闭至 2027 春"多为误传）。住景区内只买一进票，看雾不用赶首班车。',
  ...
  },
  {
    ...
    desc: '10/1 自克拉玛依西行 448km 抵达：下午环湖随停随拍，19:50 湖畔日落；明晨 07:50 看完日出再东归。宿潮克星空营地（景区内 · 已订）。',
    stay: '潮克星空营地 · 星空房（已订）', nights: 1
  },
  {
...
export const MAP_LABELS = [
  ...
  { name: '贾登峪 · 28 宿', lat: 48.500, lng: 87.130 },
